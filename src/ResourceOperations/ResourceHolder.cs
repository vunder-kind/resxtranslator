...
namespace ResxTranslator.ResourceOperations
{
    public class ResourceHolder
    {
        ...
        {
            // Если исходный - это null, то пропускаем
            ...
            // Регулярное выражение для проверки наличия русских букв (кириллица)
            Regex russianRegex = new Regex("[а-яА-Я]");
            // Дополнительно проверяем, что исходный текст на русском содержит русские буквы
